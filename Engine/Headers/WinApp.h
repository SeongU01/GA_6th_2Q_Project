...
namespace Engine
{
	...
	private:
		bool Initialize(HINSTANCE hInstance, const TCHAR* appName, int width, int height);
		// Base을(를) 통해 상속됨
		void Free() override;

	public:
		static WinApp* Create(HINSTANCE hInstance, const TCHAR* appName, int width, int height);
